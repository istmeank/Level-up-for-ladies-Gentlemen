...
const PerceptionForm: React.FC = () => {
  ...
  return <div className="min-h-[100svh]" style={{
    ...
    backgroundPosition: "center"
			...
			<div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6">
				{/* Hero Section */}
			<motion.section id="programme" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        duration: 0.6
					...
					<div className="absolute inset-0 pointer-events-none">
						<div className="absolute -left-32 -top-32 h-96 w-96 rounded-full" style={{
            background: "radial-gradient(circle at center, rgba(255,215,0,0.15), transparent 70%)"
          }} />
						<div className="absolute -right-32 -bottom-32 h-96 w-96 rounded-full" style={{
