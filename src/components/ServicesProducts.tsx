        ...
        {filteredItems.length === 0 ? <div className="text-center py-16">
            ...
            {filteredItems.map(item => <Card key={item.id} className="bg-card/60 backdrop-blur-sm border-cosmic-stellar-gold/20 hover:border-cosmic-stellar-gold/40 transition-all duration-300 group flex flex-col">
                <div className="relative overflow-hidden rounded-t-lg">
                  {item.image_url ? <img src={item.image_url} alt={item.name} className="w-full h-48 object-contain group-hover:scale-105 transition-transform duration-300 p-4" /> : <div className="w-full h-48 bg-gradient-to-br from-cosmic-stellar-gold/20 to-cosmic-nebula-green/20 flex items-center justify-center">
