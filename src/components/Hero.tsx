    ...
    <div className="relative z-10 flex flex-col items-center justify-center px-6 pt-28 md:pt-36">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="relative w-80 h-80 md:w-96 md:h-96 mb-8 md:mb-10 -mt-32">
          ...
          <div
            className="relative w-full h-full flex items-center justify-center group animate-float"
          >
            <img
              src={forLadiesGentlemenLogo}
              alt="For Ladies Gentlemen - Level Up"
              className="w-full h-full object-contain relative z-10 transition-all duration-500 animate-pulse-glow animate-reveal"
            />
            ...
            <div className="absolute inset-0 z-20">
              ...
              <div
                className={`absolute left-[14%] top-[32%] w-[6%] h-[38%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar1'
              ...
              <div
                className={`absolute left-[22%] top-[22%] w-[6%] h-[52%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar2'
              ...
              <div
                className={`absolute left-[30%] top-[12%] w-[14%] h-[64%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar3'
              ...
              <div
                className={`absolute left-[52%] top-[12%] w-[14%] h-[64%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar4'
              ...
              <div
                className={`absolute left-[72%] top-[22%] w-[6%] h-[52%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar5'
              ...
              <div
                className={`absolute left-[80%] top-[32%] w-[6%] h-[38%] cursor-pointer transition-all duration-300 ${hoveredZone === 'pillar6'
              ...
              <div
                className={`absolute right-[6%] top-[8%] w-[9%] h-[9%] cursor-pointer transition-all duration-300 ${hoveredZone === 'plus-square'
                    ? 'bg-cosmic-stellar-gold/30 shadow-[0_0_40px_hsl(var(--cosmic-stellar-gold))]'
              ...
              <div
                className={`absolute left-[14%] bottom-[12%] w-[72%] h-[10%] cursor-pointer transition-all duration-300 ${hoveredZone === 'base'
                    ? 'bg-cosmic-nebula-purple/30 shadow-[0_0_40px_hsl(var(--cosmic-nebula-purple))]'
                    : activeZone === 'base'
                      ? 'bg-cosmic-nebula-purple/30 shadow-[0_0_40px_hsl(var(--cosmic-nebula-purple))]'
                      : 'hover:bg-cosmic-nebula-purple/10 hover:shadow-[0_0_20px_hsl(var(--cosmic-nebula-purple)/0.5)]'
              ...
              >
                ...
                <div className={`absolute bottom-0 left-0 w-full transition-all duration-700 ${activeZone === 'base' ? 'h-full' : 'h-0'
