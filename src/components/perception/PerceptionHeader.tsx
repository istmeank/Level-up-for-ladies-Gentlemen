...
export const PerceptionHeader: React.FC = () => {
  return (
    <header className="relative py-10 text-center">
      <motion.div
        className="absolute right-6 top-6 text-[42px] text-perception-gold drop-shadow-[0_0_20px_rgba(255,215,0,0.5)]"
      ...
      <div className="mx-auto max-w-4xl">
        <h1 className="text-5xl font-heading font-bold tracking-wide text-perception-gold sm:text-6xl">
          PERCEPTION
        </h1>
